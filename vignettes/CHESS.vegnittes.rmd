...
packages, which also require appropriate settings of Rtools and Xcode for
...
devtools::install_github("shilab-ecnu/MR-CHESS")
```
...
We first generate the genotype data and environmental variables:
...
Furthermore, we give an example to illustrate the implementation of CHESS
